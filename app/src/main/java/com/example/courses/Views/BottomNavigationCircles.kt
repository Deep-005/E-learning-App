package com.example.courses.Views
...
class BottomNavigationCircles : BottomNavigationView {
    ...
    private var disabledColor = ContextCompat.getColor(context, R.color.unSelected)
    ...
    private fun setupRootLayout() {
        ...
        // Set the outline provider to add a shadow effect
    ...
    private fun getAppCompatImageView(@SuppressLint("RestrictedApi") itemView: NavigationBarItemView): AppCompatImageView {
        return itemView.findViewById(
            com.google.android.material.R.id.navigation_bar_item_icon_view
        )
    }

    private fun getSubTextView(@SuppressLint("RestrictedApi") itemView: NavigationBarItemView): TextView {
        return itemView.findViewById(
